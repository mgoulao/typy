...
import pandas as pd
from typy import Block, Content, DocumentBuilder, Figure, Heading, Image, Table, Text, TypstEncoder
...
print(Heading(2, "Olasdsad").encode())
...
builder.from_template(
    "template1", {"title": "Hello, World!", "date": "12/12/2023", "author": "Manel", "content1": content}
